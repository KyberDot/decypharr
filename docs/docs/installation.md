...
- GitHub Container Registry: `ghcr.io/kyberdot/decypharr:latest`
...
Download your OS-specific release from the [release page](https://github.com/kyberdot/decypharr/releases).
